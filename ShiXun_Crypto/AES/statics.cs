...
namespace ShiXun_Crypto.AES
{
    public class Statics
    {
        ...
        public static readonly byte[,] MultiplyTable = new byte[3, 256]
        {
            { 
        ...
        public static readonly byte[,] InvMultiplyTable = new byte[4, 256]
        {
            {
        ...
        public static readonly int[] ShiftIndexMap = new int[] 
        { 
            0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11 
        };

        public static readonly int[] InvShiftIndexMap = new int[]
        {
        ...
        public static readonly Dictionary<string, int> MODE = new Dictionary<string, int>
        {
            { "AES-128", 128 },
            { "AES-192", 192 },
            { "AES-256", 256 }
        ...
        public static readonly Dictionary<string, int> ROUNDS = new Dictionary<string, int>
        {
            { "AES-128", 11 },
            { "AES-192", 13 },
            { "AES-256", 15 }
